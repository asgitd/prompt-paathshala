...
function PromptEvaluatorTab({ dark }) {
  ...
  const AGENTS = [
    {
      ...
      emoji: "🎯",
      color: "#3b82f6",
      role: "Tu ek expert prompt clarity analyzer hai. User ka prompt dekh aur evaluate kar: 1. SCORE: /10 (kitna clear hai) 2. PROBLEMS: Kya missing hai ya confusing hai (2-3 points) 3. VERDICT: ek line mein summary. Response concise rakh Hindi mein."
    },
    {
      id: "effectiveness",
      ...
      emoji: "⚡",
      color: "#f59e0b",
      role: "Tu ek AI output quality expert hai. User ka prompt dekh aur evaluate kar: 1. SCORE: /10 (kitna effective hai) 2. AI RESPONSE: Is prompt se kaisa output aayega? 3. MISSING: Kya add karna chahiye. Response concise rakh Hindi mein."
    },
    {
      id: "improved",
      ...
      emoji: "🔧",
      color: "#10b981",
      role: "Tu ek expert prompt engineer hai. User ka original prompt le aur ek better improved version likh. Bas improved prompt do explanation mat dena. Hindi/Hinglish mein rakh."
    }
  ];
  ...
  const evaluatePrompt = async () => {
    ...
    const promises = AGENTS.map(async (agent) => {
      const result = await callClaude(agent.role, "Yeh prompt evaluate karo: " + prompt);
