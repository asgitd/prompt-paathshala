...
async function callClaude(systemPrompt, userMessage) {
  const apiKey = "AIzaSyBCgJvpUvLqkdnzCclpu2ZngO4K7NtF2Ms";
  if (!apiKey) {
    ...
    <div className="auth-overlay">
      <div className="auth-box">
        ...
        <div className="auth-card">
          ...
          {/* Tab Toggle */}
          {tab !== "verify" && (<div style={{display:"flex", gap:6, marginBottom:20, background:"rgba(0,0,0,0.2)", borderRadius:12, padding:4}}>
